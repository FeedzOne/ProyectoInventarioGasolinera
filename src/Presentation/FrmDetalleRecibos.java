...
public class FrmDetalleRecibos extends javax.swing.JDialog {
    ...
    public FrmDetalleRecibos(java.awt.Frame parent, boolean modal) {
        ...
        tblReceipts.getColumn("UNIT").setWidth(20);
        tblReceipts.getColumn("UNIT").setPreferredWidth(20);

        tblReceipts.getColumn("PRICE/UNIT").setWidth(20);
        tblReceipts.getColumn("PRICE/UNIT").setPreferredWidth(20);
    ...
    private void initComponents() {
        ...
        ReceivingField = new javax.swing.JTextField();
        ...
        DeliveryField.setBackground(new java.awt.Color(80, 80, 80));
        DeliveryField.setForeground(new java.awt.Color(238, 238, 238));
        ...
        tblReceipts.setBackground(new java.awt.Color(80, 80, 80));
        tblReceipts.setForeground(new java.awt.Color(238, 238, 238));
        tblReceipts.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "CODE", "DESCRIPTION", "QUANTITY", "UNIT", "PRICE/UNIT", "LINE", "TOTAL"
            }
        ));
        ...
        ReceivingField.setBackground(new java.awt.Color(80, 80, 80));
        ReceivingField.setForeground(new java.awt.Color(238, 238, 238));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(ReceivingField, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(DeliveryField, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(ReceivingField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void GenerateBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerateBTN1ActionPerformed
        ...
        if (op == JFileChooser.APPROVE_OPTION) {
            ...
            String[] titles = new String[]{"CODE","DESCRIPTION","QUANTITY","UNIT","PRICE/UNIT","LINES","TOTAL"};
            ...
            XSSFRow Date = inventoryleaf.createRow(3);
            ...
            XSSFRow Delivery = inventoryleaf.createRow(5);
            XSSFCell celldelivery1 = ID.createCell(0);
            XSSFCell celldelivery2 = ID.createCell(1);
            celldelivery1.setCellValue("DELIVERY: ");
            celldelivery2.setCellValue(DeliveryField.getText());
            
            XSSFRow Eeceiving = inventoryleaf.createRow(7);
            XSSFCell cellreceiving1 = ID.createCell(0);
            XSSFCell cellreceiving2 = ID.createCell(1);
            cellreceiving1.setCellValue("RECEIVING: ");
            cellreceiving2.setCellValue(ReceivingField.getText());
            ...
            for (int i = 0; i < tblReceipts.getRowCount(); i++) {
                ...
                inventoryRow++;
                for(int j = 0; j < tblReceipts.getColumnCount(); j++){
                    XSSFCell cell = content.createCell(j);
                    cell.setCellValue(tblReceipts.getValueAt(i, j).toString());
                }
            }
    ...
    void setReceipt(String idreceipt, String date, String receiving, String delivery) {
        IDField.setText(idreceipt);
        DateField.setText(date);
        DeliveryField.setText(delivery);
        ReceivingField.setText(receiving);
        showreceiptdetails(Integer.parseInt(idreceipt));

}
    
private void showreceiptdetails(int receiptid) {
        myModel = (DefaultTableModel) tblReceipts.getModel();
        LReceiptsDetails fun = new LReceiptsDetails();
        DReceiptsDetails dts = new DReceiptsDetails();
        dts.setReceiptID(receiptid);
        myModel = fun.showReceiptDetails(dts);
        tblReceipts.setModel(myModel);
        addTotal();
    }
...
public void addTotal() {
    ...
    private static javax.swing.JTextField DeliveryField;
    private javax.swing.JButton GenerateBTN1;
    private javax.swing.JTextField IDField;
    private javax.swing.JTextField ReceivingField;
